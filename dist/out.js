...
/* WEBPACK VAR INJECTION */(function($, __webpack_provided_window_dot_jQuery, jQuery) {console.log('$ is ', $);
console.log('window.jQuery is', __webpack_provided_window_dot_jQuery);
